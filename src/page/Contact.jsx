...
export default function Contact() {
  ...
  // Helpers for clickable contact info
  const sanitizePhoneHref = (val) => String(val).replace(/[^\d+]/g, '');
  ...
  setIsSubmitting(true);
    ...
    try {
     // const accessKey = settings?.accesskey;
      ...
      // Optional: better subject line in emails
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="flex justify-start items-start gap-4">
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-start items-start gap-2 md:gap-3">
                <div className="w-full text-black text-lg md:text-xl font-bold font-['Inter'] break-words">Location</div>
            ...
            <div className="flex justify-start items-start gap-4">
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-start items-start gap-2 md:gap-3">
                <div className="w-full text-black text-lg md:text-xl font-bold font-['Inter'] break-words">Email</div>
                <div className="w-full flex flex-col justify-start items-start gap-1 md:gap-2">
                  {settings?.contact_email && (
                    <a
                      href={`mailto:${settings.contact_email}`}
                      className="mt-1 text-sm text-green-600 hover:text-green-700 underline break-words"
                      aria-label={`Email ${settings.contact_email}`}
                    >
                      {settings.contact_email}
                    </a>
                  )}
            ...
            <div className="flex justify-start items-start gap-4 md:col-span-2 lg:col-span-1">
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-start items-start gap-2 md:gap-3">
                <div className="w-full text-black text-lg md:text-xl font-bold font-['Inter'] break-words">Phone</div>
                <div className="w-full flex flex-col justify-start items-start gap-1 md:gap-2">
                  {settings?.contact_phone && (
                    <div className="mt-1 text-sm text-gray-700 space-y-1">
                      {splitPhones(settings.contact_phone).map((ph, idx) => (
                        <div key={`${ph}-${idx}`}>
                          <a
                            href={`tel:${sanitizePhoneHref(ph)}`}
